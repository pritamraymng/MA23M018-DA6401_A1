...
Original file is located at
    https://colab.research.google.com/drive/1R387fmM3HyFs4VHeF2ba88cB9FtwZOlF
"""
...
class NeuralNetwork:
    def __init__(self, layer_sizes, weight_init="random", activation="sigmoid",beta=0.9, beta1=0.9, beta2=0.999, weight_decay=0.0, loss_type= 'cross_entropy'):
    ...
    def compute_loss(self, y_true, y_pred, batch_size, weight_decay):
        ...
        if self.loss_type == 'cross_entropy':
            ...
            raise ValueError("Loss type not defines")
    def plot_loss_chart(self, epochs, train_acc, val_acc):
    ...
    def train_model(self, x_train, y_train_raw, y_train_enc,x_val, y_val_raw, y_val_enc,num_hidden_layers, num_neurons, optimizer_type,
        ...
        fig = self.plot_loss_chart(epochs_range, train_acc_list, val_acc_list)
        plt.show()

        return self.parameters, train_losses, val_losses, train_acc_list, val_acc_list
...
#Best Hyperparameter Values with cross entropy loss
epochs = 10
num_hidden_layers = 5
num_neurons = 128
learning_rate = 1e-4
...
# Training-
params, train_losses, val_losses, train_acc, val_acc = nn.train_model(
    x_train=X_train,
...
#Best Hyperparameter Values with mse loss
epochs = 10
num_hidden_layers = 5
num_neurons = 128
learning_rate = 1e-4
